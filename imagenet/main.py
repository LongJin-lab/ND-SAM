...
parser.add_argument('--data', metavar='DIR',default='/media2/datasets/imagenet/',#'/data1/ILSVRC2012',#
...
def main():
    ...
    if args.optimizer == 'sgd':
        ...
        optimizer = Hadam(model.parameters(), lr=args.lr,weight_decay=args.weight_decay)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        adjust_learning_rate(optimizer, epoch, args.when)
