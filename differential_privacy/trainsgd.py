...
logger = Logger('dpsgd_0.005_wrn_10.txt', title='mnist')
...
if __name__ == "__main__":
    ...
    optimizer = MomentumDP(net.parameters(), lr=args.learning_rate, momentum=args.momentum, weight_decay=args.weight_decay)
    
    # optimizer = DPSGD(net.parameters(), lr=args.learning_rate, batch_size=args.batch_size//args.microbatches, momentum=args.momentum, weight_decay=args.weight_decay, dampening=args.dampening)
