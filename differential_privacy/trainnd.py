...
logger = Logger('ndsamDP_0.005_iv3_10.txt', title='mnist')
...
if __name__ == "__main__":
    ...
    testset = torchvision.datasets.CIFAR10(
        root='/media/ds/nd_sam/data', train=False, download=True, transform=transform_test)
    ...
    # trainset = train_set = torchvision.datasets.MNIST(root="./data",train=True,transform=torchvision.transforms.Compose([
    ...
    # testset = torchvision.datasets.MNIST(root="./data",train=False,transform=torchvision.transforms.Compose([
    #                            transforms.Resize((32, 32)),
    #                            torchvision.transforms.ToTensor(),
    #                            torchvision.transforms.Normalize(
    #                              (0.1307,), (0.3081,))
    ...
    # net = WideResNet(args.depth, args.width_factor, args.dropout, in_channels=1, labels=10).to(device)

    base_optimizer = ND
    optimizer = NDSAMDP(net.parameters(), base_optimizer, rho=args.rho, adaptive=args.adaptive, lr=args.learning_rate, momentum=args.momentum, weight_decay=args.weight_decay, dampening=args.dampening)
